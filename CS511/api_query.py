...
for x in range(len(q)):
    ...
    random.shuffle(keys) # shuffle the key list
    for key in keys : s_answers.update({key : answers[key]}) # create the shuffled answers 
    ...
    if answer_key[answer - 1] == q[x]["correct_answer"]: 
        ...
        print("Sorry, that was incorrect.\nThe correct answer was: " + str(html.unescape(q[x]["correct_answer"])))
